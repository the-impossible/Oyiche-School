...
def populate_foreign_keys_with_uuid(apps, schema_editor):
    ...
    for obj in SchoolInformation.objects.all():
        ...
        obj.school_category_uuid = obj.school_category.sch_category_id if obj.school_category else None
        obj.school_type_uuid = obj.school_type.sch_type_id if obj.school_type else None
    ...
    for obj in StudentScores.objects.all():
        ...
        obj.grade_uuid = obj.grade.sch_grade_id if obj.grade else None
