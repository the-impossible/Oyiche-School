    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_description', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userType', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='oyiche_auth.usertype')),
            ],
            options={
